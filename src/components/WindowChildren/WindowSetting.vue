      ...
      <div class=" tw-w-full  tw-h-full tw-rounded-b-2xl tw-overflow-hidden tw-flex
       tw-select-none" @contextmenu.prevent="mr_clicked">
        <div class=" tw-w-52 tw-bg-white tw-h-full tw-flex tw-flex-col tw-px-3 tw-py-2 tw-flex-none" >
          <WindowSettingIcon :tag="'账户'" :img="'profile'" :selected_tag="selected_tag" @click.native="{selected_tag = '账户';selected_tag_2 = '关于此项目'}"/>
          <WindowSettingIcon :tag="'技能'" :img="'skills'" :selected_tag="selected_tag"  @click.native="{selected_tag = '技能';selected_tag_2 = '技能点'}"/>
        ...
        <div class=" tw-flex-grow tw-h-full  tw-p-2">
          <div class="tw-w-full tw-h-full  tw-flex">
            ...
            <div class="tw-flex-grow tw-bg-white tw-h-full">
              ...
              <div class="tw-w-full tw-h-full" v-if="selected_tag === '技能'">
                <div ref="overall_page" class="tw-w-full tw-h-full tw-items-center tw-flex tw-flex-col tw-justify-center" style="text-align:center" v-if="selected_tag_2 ==='技能点'">
